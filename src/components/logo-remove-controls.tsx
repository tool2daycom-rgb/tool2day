    ...
    <div className="sm:col-span-2 space-y-4 rounded-xl border border-[#e8e8e8] bg-[#fafafa] p-4">
      <div>
        ...
        <p className="mt-1 text-xs leading-6 text-[#666]">
          ارسم مربعاً صغيراً على العلامة فقط. النظام يعيد بناء السطح من جهة
          الحذاء/الخلفية المجاورة شريحة بشريحة لإظهار ما تحت العلامة — بدون مربع
          غبش سميك.
        </p>
      </div>
