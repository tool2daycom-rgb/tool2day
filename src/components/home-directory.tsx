          ...
          return (
            <li key={tool.slug}>
              <Link
                ...
                className="group flex items-center gap-3 text-[#222] transition hover:text-[#2563eb]"
              >
                <Icon className="h-5 w-5 shrink-0 stroke-[1.5] text-[#333] transition group-hover:text-[#2563eb]" />
