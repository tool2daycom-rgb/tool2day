...
export default function PrivacyPage() {
  return (
    <article
      dir="ltr"
      className="mx-auto w-full max-w-3xl px-4 py-12 text-left text-[#333] sm:px-6 sm:py-16"
    >
      <div className="space-y-4 text-[15px] leading-7 [&_a]:font-medium [&_a]:text-[#2563eb] [&_a]:underline-offset-2 hover:[&_a]:underline [&_h1]:mt-10 [&_h1]:mb-3 [&_h1]:text-2xl [&_h1]:font-bold [&_h1]:text-[#111] [&_h1]:first:mt-0 sm:[&_h1]:text-3xl [&_h2]:mt-8 [&_h2]:mb-2 [&_h2]:text-xl [&_h2]:font-bold [&_h2]:text-[#111] [&_li]:my-1.5 [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:ps-5">
        <h1>Privacy Policy</h1>
        <p>Updated at 2026-07-19</p>

        <p>
          tool2day (“we,” “our,” or “us”) is committed to protecting your
          privacy. This Privacy Policy explains how your personal information is
          collected, used, and disclosed by tool2day.
        </p>
        <p>
          ...
          tool2day. By accessing or using our Service, you signify that you have
          ...
          <a href="https://termify.io" target="_blank" rel="noopener noreferrer">
            Termify
          </a>
          .
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            it refers to wisam dandash, Kaiser-Friedrich-Str. 139 .-75172 -
            Pforzheim that is responsible for your information under this
            Privacy Policy.
          </li>
          <li>
            Country: where tool2day or the owners/founders of tool2day are
            based, in this case is brasil
          </li>
          <li>
            Customer: refers to the company, organization or person that signs
            up to use the tool2day Service to manage the relationships with your
            consumers or service users.
          </li>
          <li>
            Device: any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit tool2day and
            use the services.
          </li>
          <li>
          ...
          <li>
            Personnel: refers to those individuals who are employed by tool2day
          ...
          <li>
            Service: refers to the service provided by tool2day as described in
          ...
          <li>
            Website: tool2day&apos;s site, which can be accessed via this URL:{" "}
            <a href="https://www.tool2day.com/">https://www.tool2day.com/</a>
          </li>
          <li>
            You: a person or entity that is registered with tool2day to use the
            Services.
          </li>
        </ul>
        ...
        <h2>Personnel</h2>
        <p>
          If you are a tool2day worker or applicant, we collect information you
        ...
        <p>
          ...
          of the assets of tool2day or any of its Corporate Affiliates (as
          defined herein), or that portion of tool2day or any of its Corporate
        ...
        <p>
          ...
          control with tool2day, whether by ownership or otherwise. Any
        ...
        <h2>Governing Law</h2>
        <p>
          This Privacy Policy is governed by the laws of brasil without regard
        ...
        <p>
          The laws of brasil, excluding its conflicts of law rules, shall
        ...
        <p>
          By using tool2day or contacting us directly, you signify your
        ...
        <p>
          ...
          tool2day. We are not responsible for the content, accuracy or opinions
          ...
          our platform, is subject to that website’s own rules and policies. Such
        ...
        <p>
          ...
          party sites. tool2day does not make any representation as to the
        ...
        <p>
          Advertising keeps tool2day and many of the websites and services you
        ...
        <p>
          ...
          tool2day of the third party sites, goods or services. tool2day takes
        ...
        <h2>Cookies</h2>
        <p>
          tool2day uses &quot;Cookies&quot; to identify the areas of our website
        ...
        <p>
          ...
          internet to people who have already visited your website. It allows
          your company to seem like they&apos;re “following” people around the
        ...
        <p>
          ...
          child has provided Us with Personal Data without your permission,
        ...
        <p>
          ...
          or provide links to third-party websites or services (&quot;Third-
          Party Services&quot;).
        </p>
        <p>
          You acknowledge and agree that tool2day shall not be responsible for
          ...
          or any other aspect thereof. tool2day does not assume and shall not
        ...
        <p>
          ...
          how we maintain this data under protection from being replicated or
        ...
        <p>
          ...
          irrespective of where they are located, which is why we have
        ...
        <p>
          ...
          thing to do. At tool2day we strongly believe that your data privacy is
        ...
        <p>
          ...
          requirements of GDPR. tool2day processes or stores all personal data
