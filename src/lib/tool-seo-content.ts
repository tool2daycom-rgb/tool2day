...
function defaultContent(tool: Tool): ToolSeoContent {
  ...
  return {
    tagline: `${name} مجاناً مباشرة من المتصفح — بدون علامة مائية`,
...
const overrides: Partial<Record<string, ToolSeoContent>> = {
  "screen-recorder": {
    tagline: "سجّل الشاشة مباشرة من متصفحك — مجاناً وبدون علامة مائية",
  ...
  "enhance-video": {
    tagline:
      "حسّن وضوح الفيديو حتى 4K مجاناً — بدون علامة مائية، معالجة في المتصفح",
