...
const overrides: Record<string, ToolSeoContent> = {
  ...
  "ebook-converter": {
    tagline: "تحويل EPUB غير المحمي إلى PDF نصي — في المتصفح",
    introTitle: "محوّل الكتب الإلكترونية عبر الإنترنت",
    intro:
      "محوّل الكتب الإلكترونية على Tool2Day يحوّل ملفات EPUB غير المحمية إلى PDF نصي بسيط، أو يعيد تنزيل PDF كما هو. الأداة لا تزيل DRM ولا تتجاوز حماية الكتب التجارية أو التعليمية. استخدمها فقط على ملفات تملك حق تحويلها، مثل مستنداتك الشخصية أو الكتب المفتوحة المصدر.",
    howTitle: "كيف أحوّل كتاباً إلكترونياً؟",
    howIntro: "اتبع الخطوات بالترتيب:",
    steps: [
      {
        title: "1. جهّز ملفاً غير محمي",
        body: "تأكد أن ملف EPUB أو PDF ليس محمياً بكلمة مرور أو DRM تجاري.",
      },
      {
        title: "2. ارفع الملف",
        body: "اختر EPUB أو PDF من جهازك عبر زر الرفع في الصفحة.",
      },
      {
        title: "3. ابدأ التحويل",
        body: "اضغط بدء المعالجة؛ يستخرج النص من EPUB غير المحمي إلى PDF نصي، أو يعيد PDF كما هو.",
      },
      {
        title: "4. نزّل النتيجة",
        body: "احفظ ملف PDF الناتج على جهازك وراجع النص قبل الاستخدام النهائي.",
      },
    ],
    formatsTitle: "الصيغ المدعومة",
    formatsIntro:
      "التحويل مخصص للصيغ المفتوحة غير المحمية فقط. لا تدعم الأداة إزالة الحماية أو كسر قفل الكتب.",
    formats: [
      { label: "EPUB", note: "كتب EPUB بدون DRM — استخراج نص إلى PDF." },
      { label: "PDF", note: "إعادة تنزيل كما هو دون تعديل الحماية." },
      { label: "غير مدعوم", note: "MOBI/AZW المحمي أو أي ملف يتجاوز DRM." },
    ],
    moreTitle: "احترام حقوق النشر",
    moreBody:
      "Tool2Day لا يشجع على قرصنة الكتب. إن كان ملفك محمياً، استخدم البرنامج أو المتجر الرسمي الذي منحك الترخيص. لتحويل مستنداتك الخاصة يمكنك أيضاً استخدام أدوات PDF الأخرى في الموقع.",
    whyTitle: "لماذا تختارنا",
    why: [...FREE_WHY_AR],
    faqs: [
      {
        q: "هل الأداة تزيل حماية DRM؟",
        a: "لا. نحوله فقط EPUB غير المحمي إلى PDF نصي، ولا نتجاوز أنظمة الحماية.",
      },
      {
        q: "هل يدعم MOBI؟",
        a: "لا حالياً. الصيغ المدعومة هي EPUB وPDF غير المحميين.",
      },
      {
        q: "هل التحويل مجاني؟",
  ...
  "png-library": {
    tagline: "صور PNG شفافة من مصادر مرخّصة — مع ذكر المصدر",
    introTitle: "مكتبة PNG بدون خلفية",
    intro:
      "مكتبة PNG على Tool2Day تساعدك على تصفّح صور شفافة من مصادر مثل Pixabay وOpenverse ومجتمع الموقع، مع إظهار المصدر. لا تستخدم الصور لأغراض تنتهك حقوق الطبع والنشر، ولا ترفع شخصيات أو شعارات لا تملك ترخيصها. عند التنزيل التزم برخصة المصدر الظاهر في البطاقة.",
    howTitle: "كيف أستخدم مكتبة PNG؟",
    howIntro: "اتبع الخطوات بالترتيب:",
    steps: [
      {
        title: "1. ابحث عن موضوع عام",
        body: "اكتب كلمة عامة مثل clipart أو icon وتجنب أسماء شخصيات أو علامات تجارية محمية.",
      },
      {
        title: "2. راجع المصدر والترخيص",
        body: "افتح رابط المصدر إن وُجد واقرأ شروط الاستخدام قبل التنزيل أو إعادة النشر.",
      },
      {
        title: "3. نزّل PNG",
        body: "اضغط تنزيل واحفظ الملف لاستخدامك الشخصي أو حسب الرخصة المسموحة.",
      },
      {
        title: "4. ارفع أعمالك الأصلية فقط",
        body: "عند المساهمة في المجتمع ارفع ملفات تملك حقوقها، بدون شعارات أو شخصيات مشهورة مسروقة.",
      },
    ],
    formatsTitle: "الصيغ والمصادر",
    formatsIntro: "المكتبة تركز على PNG الشفاف مع مصادر خارجية مرخّصة أو رفع مجتمعي.",
    formats: [
      { label: "PNG", note: "صور شفافة أو عادية بصيغة PNG." },
      { label: "Pixabay / Openverse", note: "نتائج من واجهات برمجية مع صفحة مصدر." },
      { label: "مجتمع Tool2Day", note: "رفع مستخدمين — يتحمل الرافع صحة الترخيص." },
    ],
    moreTitle: "حقوق الطبع والنشر",
    moreBody:
      "Tool2Day وسيط عرض فقط. إزالة صورة عند بلاغ DMCA ممكنة عبر صفحة الاتصال. لا تضمن الأداة أن كل نتيجة خارجية خالية من التعارضات؛ راجع المصدر دائماً.",
    whyTitle: "لماذا تختارنا",
    why: [...FREE_WHY_AR],
    faqs: [
      {
        q: "هل كل الصور حرة للاستخدام التجاري؟",
        a: "ليس بالضرورة. راجع رخصة المصدر (Pixabay/Openverse/الرافع) قبل الاستخدام التجاري.",
      },
      {
        q: "هل أستطيع رفع شعارات أو شخصيات مشهورة؟",
        a: "لا. ارفع فقط ملفات تملك حقوقها أو لديك ترخيص صريح بها.",
      },
      {
        q: "كيف أبلغ عن انتهاك؟",
        a: "تواصل عبر صفحة الاتصال مع رابط الصورة ووصف البلاغ.",
      },
    ],
  },
