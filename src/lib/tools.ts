...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description:
      "زخرفة الأسماء والنصوص مجاناً أونلاين — أنماط يونيكود وإطارات عربية للألعاب وانستغرام وتيك توك بدون علامة مائية.",
    category: "generators",
    accept: "text/plain",
    icon: Sparkles,
  },
  ...
  },
  {
    ...
    description:
      "أنشئ ترجمة فيديوهاتك تلقائياً وبكل سهولة! استخرج النصوص، خصص شكل الخطوط وألوانها، وراقب المعاينة المباشرة على الفيديو. أداتك الذكية لتوليد ملفات الترجمة الاحترافية مجاناً وبدون تعقيد.",
    category: "social-dev",
    accept: "video/*,audio/*",
    icon: Captions,
  },
  ...
  },
  {
    ...
    title: "محوّل الأرشيف",
    description: "حوّل أرشيف ZIP أو حزم ZIP (مثل EPUB/DOCX) إلى ملف ZIP نظيف.",
    category: "converters",
  ...
  },
  {
    ...
    description: "فك ضغط ملفات ZIP وتنزيل المحتويات كأرشيف نظيف.",
    category: "converters",
  ...
  },
  {
    ...
    title: "محوّل الخطوط",
    description:
      "غيّر امتداد ملف الخط (TTF/OTF/WOFF) للتنزيل — إعادة الترميز الكاملة غير متاحة في المتصفح.",
    category: "converters",
